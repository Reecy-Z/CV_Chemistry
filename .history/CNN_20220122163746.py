...
for i in range(split):
    ...
    train_reaction.append(torch.Tensor(catalyst_data))
    train_reaction.append(torch.Tensor(imine_data))
    train_reaction.append(torch.Tensor(thiol_data))
...
for i in range(split,1075):
    ...
    test_reaction.append(torch.Tensor(catalyst_data))
    test_reaction.append(torch.Tensor(imine_data))
    test_reaction.append(torch.Tensor(thiol_data))

    test_fea.append(train_reaction)
    test_label.append(data['Output'][i])

featuresTrain = torch.Tensor(train_fea)
