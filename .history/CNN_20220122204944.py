...
def generate_traindataloader_cat():
    ...
    data_loader = torch.utils.data.TensorDataset(feaTrain,targetsTrain)
    data_loader = torch.utils.data.DataLoader(data_loader, batch_size = 600, shuffle=True)
...
def generate_testdataloader_cat():
    ...
    data_loader = torch.utils.data.DataLoader(data_loader, batch_size = 475, shuffle=True)
