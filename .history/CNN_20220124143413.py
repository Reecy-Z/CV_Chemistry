...
# 18 science
Ligand = utils.get_molecule_dict('Catalyst',file)
Base = utils.get_molecule_dict('Imine',file)
Additive = utils.get_molecule_dict('Thiol',file)
Aryl_halide = utils.get_molecule_dict('Thiol',file)
