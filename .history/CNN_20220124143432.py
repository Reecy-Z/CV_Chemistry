...
# 18 science
Ligand = utils.get_molecule_dict('Ligand',file)
Base = utils.get_molecule_dict('Base',file)
Additive = utils.get_molecule_dict('Additive',file)
Aryl_halide = utils.get_molecule_dict('Aryl_halide',file)

train_loader = utils.generate_traindataloader_cat()
test_loader = utils.generate_testdataloader_cat()
