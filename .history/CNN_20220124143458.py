...
Base = utils.get_molecule_dict(file,'Base',file)
Additive = utils.get_molecule_dict(file,'Additive',file)
Aryl_halide = utils.get_molecule_dict(file,'Aryl_halide',file)
