...
# 18 science
save_images(Ligand,'Catalyst','18 science')
save_images(Additive,'Imine','18 science')
save_images(Base,'Thiol','18 science')
save_images(Aryl_halide,'Catalyst','18 science')
