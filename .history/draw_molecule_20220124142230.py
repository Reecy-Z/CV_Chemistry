...
Base = deduplicationt_molecule('Base','18 science')
Aryl_halide = deduplicationt_molecule('Aryl_halide','18 science')
...
# 18 science
save_images(Ligand,'Ligand','18 science')
save_images(Additive,'Additive','18 science')
save_images(Base,'Base','18 science')
save_images(Aryl_halide,'Aryl_halide','18 science')
