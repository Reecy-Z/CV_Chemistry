...
train_loader = utils.generate_Traindata_loader(file,split,dicts,batch_size,Dir)
test_loader = utils.generate_Testdata_loader(file,split,end,dicts,batch_size,Dir)
